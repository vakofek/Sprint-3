...
export class NoteCardActions extends React.Component {
    ...
    getCardIcon = () => {
        switch (this.state.note.type) {
            case 'text':
                return <i className="card-type-icon fas fa-font"></i>
            case 'sound':
                return <i className="card-type-icon fab fa-itunes-note"></i>
            case 'video':
                return <i className="card-type-icon fab fa-youtube"></i>
            case 'img':
                return <i className="card-type-icon far fa-image"></i>
            case 'list':
                return <i className="card-type-icon fas fa-list"></i>
